...
package com.hrules.imclean.data.repository;

import android.support.annotation.NonNull;
import com.hrules.imclean.data.exceptions.NotCacheExpiredException;
import com.hrules.imclean.data.exceptions.PopulateException;
...
public abstract class Repository<T extends ModelDto> implements RepositoryInterface<T> {
  ...
  @SuppressWarnings("unchecked") @Override public void query(@NonNull Specification specification, @NonNull QueryCallback callback) {
    ...
    try {
      ...
      callback.onFailure(new PopulateException(e));
    }
    callback.onFinish();
  }
}
